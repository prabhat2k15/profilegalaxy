            ...
            <!--div class="nav notify-row" id="top_menu" style="float: left;"-->
                ...
                <ul class="nav navbar-right top-nav" style="float: left;">
                    ...
                    <li class="dropdown" style="float: left;">
                        ...
                        <ul class="dropdown-menu extended tasks-bar" style="background-color: rgba(255, 255, 0, 0);" >
                            <div style="background-color:white; width: 250px; margin-left: 170px;">
                    ...
                    <li id="header_inbox_bar" class="dropdown" style="float: left;">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
