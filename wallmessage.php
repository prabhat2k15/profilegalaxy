...
include('connection.php');
	$qry_result = mysql_query("Select * from postmsg where username='$email' order by timestamp desc") or die(mysql_error());
if(true)
{
                                  ...
                                  <ul id="sortable" class="task-list">
                                      ...
                                      <li class="list-info">
										...
										while($row121 = mysql_fetch_row($queryprofile))
												{ //for profile pic	?>
										  <p class="right"><a href="profile.php"><h3><img src="uploads/profilepic/<?php echo $row121[0]; } ?>" class="img-circle" width="60"></a>  
