<html>
<head>
	<title>Latest news and event</title>
		<style type="text/css">
		#insert{
...
<?php include_once('connection.php')?>
					...
					<center style="color:red;"><h1><?php echo @$_GET['deleted_data']?></h1></center>
					<!--End of show-->
					<!-- Latest news and event inseert section start-->
					<table width="1000" align="center">
 						<tr>
 							<td align="center" bgcolor="#006CBB" colspan="2" style="color:white"><h1>Latest news & Events </h1></td>
 						</tr>
...
?><!-- End of insert data into news & event-->
    ...
    <table width="1200" border="1" align="center">
        <tr><th colspan="6" bgcolor="#006CBB" style="color:white;"><h1>News & Events</h1></th></tr>
        <tr>
            <th width="75">Id</th>
